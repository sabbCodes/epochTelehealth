...
export function HealthRecordForm({ patientName, patientId, doctorId, onSave, onCancel }: HealthRecordFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.diagnosis || !formData.symptoms || !formData.treatment) {
      toast({
        ...
        description: "Please fill in at least diagnosis, symptoms, and treatment fields.",
        variant: "destructive",
      });
      return;
    }
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-md flex items-start space-x-2">
          ...
          <div className="text-sm text-amber-800 dark:text-amber-300">
            This record will be encrypted & securely stored on the blockchain, powered by Arcium.
          </div>
        </div>
      </CardContent>
