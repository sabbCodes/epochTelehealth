 ...
 * IDL can be found at `target/idl/telehealthsol_escrow.json`.
 */
export type TelehealthsolEscrow = {
  "address": "8Y3VY6D5PLVu7BASTyK6rERs3vRUwFKin4yGMabmC6GY",
  "metadata": {
    "name": "telehealthsolEscrow",
    "version": "0.1.0",
    "spec": "0.1.0",
